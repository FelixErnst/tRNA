...
arguments can be added to `gettRNAFeaturePlots` or used from the `score` column
of the `GRanges` objects. For the first provided a list of scores with the same 
...
The plots can be of course modified.
